...
Copyright Gregory Tomlinson (email : gregory.tomlinson@gmail.com | http://gregorytomlinson.com/encoded/)
...
class LastFMRecentTracksWidget {
	...
	function LastFMScrobblerFeed() { $this->__construct(); }
...
EOD;
	...
	function widget_lastfmrecentracks_controls() {
		...
		$db_data = get_option($this->safe_name);
		$image_url = get_option('siteurl') . '/wp-content/plugins/lastfm_recent_tracks/images/lastfm.png';
...
EOD;
	...
	function serveHeader() {
	  ...
	  (function() {
	    ...
	    s.src = "$siteurl/wp-content/plugins/lastfm_recent_tracks/js/LastFMPipe.js";
